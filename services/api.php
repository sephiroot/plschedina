...
class API extends REST
{
    ...
    */
    ...
    /**
     * Liste delle partite per la giornata
     */
    private function day()
    {
        ...
        $giornata = (int)$this->_request['day'];
        // seleziona le partite in base alla giornata calcistica scelta
        $query = "SELECT * FROM test_table WHERE day_game = $giornata";
        ...
        if ($r->num_rows > 0) {
            ...
            error_log(print_r($this->json($result), TRUE));
